        ...
        this.draw = function () {
            ...
            if(this.o.skin == 'tron') {
                ...
                if (this.o.displayPrevious) {
                    ...
                    c.arc(this.xy, this.xy, this.radius - this.lineWidth, sa, ea, false);
                    c.stroke();
                }

                c.beginPath();
                c.strokeStyle = r ? this.o.fgColor : this.fgColor ;
                c.arc(this.xy, this.xy, this.radius - this.lineWidth, sat, eat, false);
                c.stroke();

                c.lineWidth = 2;
                c.beginPath();
                c.strokeStyle = this.o.fgColor;
                c.arc(this.xy, this.xy, this.radius - this.lineWidth + 1 + this.lineWidth * 2 / 3, 0, 2 * Math.PI, false);
                c.stroke();
